...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/Soujanya8977/AirBnB_Repo/master/AirBnB/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -49494.95687073869
exported_pipeline = DecisionTreeRegressor(max_depth=4, min_samples_leaf=16, min_samples_split=6)
...
encoder_location = 'https://github.com/Soujanya8977/AirBnB_Repo/blob/master/AirBnB/encoder.pkl?raw=true'
